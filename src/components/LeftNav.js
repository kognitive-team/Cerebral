...
import { Menu, Sidebar, Icon, Header, Segment, Image, Grid} from 'semantic-ui-react'

class LeftNav extends React.Component{
    render(){
        return (

            <div class="ui sidebar vertical inverted menu sidebar-menu" id="sidebar">
                <a href="#" className="ui small image">
                    <img src="images/logo/KognitiveLogo.png" />
                </a>
            <div class="item">
